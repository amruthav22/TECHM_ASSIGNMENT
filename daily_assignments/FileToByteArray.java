...
public class FileToByteArray {
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\amrutha\\Downloads\\prac.txt";
        ...
        try {
            ...
            byte[] fileBytes = new byte[(int) fileSize]; // Cast to int is safe since file size is usually within int
                                                         // range
            ...
            if (bytesRead != fileSize) {
                System.err.println(
                        "Error: Could not read the entire file. Bytes read: " + bytesRead + ", Expected: " + fileSize);
            }
